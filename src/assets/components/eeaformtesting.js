...
<div style="width: 30%; min-width: 300px; z-index: 999; rgba(255, 255, 255, 0.95); position: fixed;bottom: 0; padding: 10px; margin: 4px; border: solid 1px #ccc;background-color:#fff; box-shadow: 5px 5px 5px #888888;">	
