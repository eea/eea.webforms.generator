 ...
 * Class XSDWebForm
 * XSD Schema to HTML5
 * PolyForm / PolyGroup (can add rows) / PolymultiSubGroup(todo:tabbed) (Subgroup inside Subgroup), TODO: Array of input type instead of ; separators and maybe PolyPage
 */
