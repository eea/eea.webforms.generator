...
// Check 1: If "nodemon" has been triggered=>log envriroment user, file etc=>git commit changes (rollback + staging capability + image/clone new server on the fly + update server farm on the fly, works with database too?)
