...
- Lookup Component. When adding row, get data from existing instance
  Store returned REST/Json data to a Hash Array lookup/url+lu-value etc and check the Hash for existing data e.g. Data[crc32(urlstring + lu-value string)] = json data
