		...
		form: {
			save : function ($scope) {
				$("form.eeaform").each(function(index, form){
						...
						//TODO: Maybe a DB status flag (i.e. 0 created/saved, 1 commited - leave it "open" for future statuses). In order to be Commited it needs to be valid. It can be saved without all elements completed but not commited.			    
