...
class XSDWebFormParser 
{
    ...
    parse(xObject) 
    {
        ...
        var xmltItem = new XmlDocument(xObject.xdata);
        xmltItem.level = 0;
    ...
    htmlParse(htmlItem) 
    {
        ...
        for (let i = 0, l = htmlItem.children.length; i < l; i++) {
            if (htmlItem.children[i].type === "element") {
                ...
                this.parseHTMLItem(htmlItem.children[i].name);
                this.htmlParse(htmlItem.children[i]);
            }
        };
    ...
    parseHTMLItem(item) 
    {
        ...
        if ((item in this.HTML_TYPES)) {
            (this.HTML_TYPES[item])(item);
        } else {
    ...
    logXSD(xObject){
        ...
        console.log(`                                                             \x1b[1m\x1b[33mFILE : ${xObject.xfile} \x1b[0m\n`);
    ...
    logHTML(xObject){
        ...
        console.log(`                                                             \x1b[1m\x1b[36mFILE : ${xObject.hfile} \x1b[0m\n`);
