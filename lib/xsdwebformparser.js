...
class XSDWebFormParser 
{
    ...
    xsdParse(xml) 
    {
        ...
        if (this.showLog) {
            ...
            console.log(`\x1b[36m_______________________________________________________ \x1b[31mFILE : ${xml.file} \x1b[36m___________________________________________________________\n\x1b[0m`); 
            console.log("\x1b[36m____________________________________________________________________________________________________________________________________\n\x1b[0m"); 
        }
    ...
    showItemLog(xmltItem)
    {
        ...
        console.log(`${xspace}░░░░░░░░░░░░░ `);
        process.stdout.write(`${xspace}░░░░ L:${xmltItem.level} ░░░░\x1b[31m⇢\x1b[0m `);
        ...
        if (xmltItem.children) {
            ...
            if (xmltItem.xparent) {
                ...
                if (xmltItem.xparent.attr.name) {
                    console.log(`${xspace}░░░░░░░░░░░░░ \x1b[36m par.name ::\x1b[1m ${xmltItem.xparent.attr.name}\x1b[0m`);
                }
            }
        } 
