    ...
    xsdInnerParse(xmltItem) 
    {
        ...
        if (this.showLog) {
            ...
            if (xmltItem.children) {
                console.log(`\x1b[1m${xmltItem.name} :: ${xmltItem.attr.name}\x1b[0m`);
                // console.log(`\n[ =====================>---------------- ${xmltItem.name} | ${xmltItem.type} | ${xmltItem.children.length} ]`);
                if (xmltItem.xparent) {
                    console.log(`\x1b[32m${xspace}░░░░░░░░░░░░░ parent :: ${xmltItem.xparent.name}\x1b[0m`);

                    if (xmltItem.xparent.attr.name) {
                        console.log(`\x1b[36m${xspace}░░░░░░░░░░░░░ par.name :: ${xmltItem.xparent.attr.name}\x1b[0m`);
                    }
                }
            }
